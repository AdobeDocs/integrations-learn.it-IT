...
* Descrizione dei requisiti di implementazione per Adobe [!DNL Analytics] con Adobe [!DNL Target] (A4T)
...
>[!VIDEO](https://video.tv.adobe.com/v/3421726/?captions=ita&quality=12&learn=on)
...
Il pannello [!DNL Analytics] per [!DNL Target] (A4T) consente di analizzare le attività e le esperienze Adobe [!DNL Target] in Analysis Workspace con incremento e affidabilità.

>[!VIDEO](https://video.tv.adobe.com/v/326715/?captions=ita&quality=12&learn=on)
...
>[!VIDEO](https://video.tv.adobe.com/v/3412969/?captions=ita&quality=12&learn=on)
...
Un’attività di allocazione automatica identifica un vincitore tra due o più esperienze e, di conseguenza, ridistribuisce automaticamente più traffico per il vincitore, mentre il test continua a essere eseguito e ad apprendere. L&#39;integrazione [!DNL Analytics] per [!DNL Target] (A4T) per Allocazione automatica consente di visualizzare i dati di reporting in Adobe [!DNL Analytics] e di ottimizzare eventi o metriche personalizzate definite in [!DNL Analytics].
...
L&#39;integrazione [!DNL Analytics] per [!DNL Target] (A4T) per le attività Auto-[!DNL Target] utilizza gli algoritmi di machine learning (ML) di Adobe [!DNL Target] per scegliere l&#39;esperienza migliore per ogni visitatore in base al profilo, al comportamento e al contesto, il tutto mentre si utilizza una metrica di obiettivo di Adobe [!DNL Analytics].

Sebbene in Adobe [!DNL Analytics] Analysis Workspace siano disponibili funzionalità di analisi avanzate, sono necessarie alcune modifiche al pannello predefinito [!DNL Analytics] per [!DNL Target] per interpretare correttamente le attività Auto-[!DNL Target], a causa delle differenze tra le attività di sperimentazione (test A/B manuale e Allocazione automatica) e le attività di personalizzazione (Auto-[!DNL Target]).
