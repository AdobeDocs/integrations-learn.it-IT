...
<thead>
 ...
 <tr>
   ...
   <td><ul style="margin-top: 0;">
          <li>Implementazione in un singolo store su AEM
          <li>Implementazione globale di più store in AEM</li>
   ...
   <td>
    <ul style="margin-top: 0;">
          ...
          <li>Supporto di più ambienti per Adobe [!DNL Commerce].</li>
 ...
 <tr>
   ...
   <td>Valuta la conversione dei negozi e-commerce funnel, gli ordini, i ricavi e le metriche per visite e visitatori.</td>
