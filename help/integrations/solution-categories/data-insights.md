...
<!--  ROW 2a  -->
<td>Analizzare i risultati dei test di ottimizzazione, incluso il test A/B, utilizzando Adobe [!DNL Target] e generando report completi tramite Adobe [!DNL Analytics].</td>
...
<!--  ROW 2b  -->
<tr>
   <td>Invia i dati del segmento di Audience Manager a [!DNL Analytics] per un'analisi più approfondita del pubblico, l'individuazione e l'ottimizzazione.</td>
    <td><ul style="margin-top: 0;">
...
<tr>
   <td>Espandi i tipi di pubblico per le piattaforme di personalizzazione e annunci.</td>
    <td><ul style="margin-top: 0;">
        <li>Utilizza l'inoltro lato server per inviare dati [!DNL Analytics] ad Audience Manager per creare segmenti.</li>
       </ul></td>
   <td><a href="../integrations-between-applications/aam/aam-analytics.md" target="_blank" rel="noopener noreferrer">AUDIENCE MANAGER e [!DNL Analytics]</a></td>
 </tr>
...
<!--  ROW 2e  -->
<tr>
   <td>Monitora, analizza e segnala le attività degli utenti sui siti Web di AEM Sites utilizzando Adobe [!DNL Analytics] per ottenere informazioni e report completi.</td>
   <td><ul style="margin-top: 0;">
...
<!--  ROW 2f  -->
<tr>
   <td>Ottieni informazioni complete sulle campagne di marketing via e-mail di Adobe [!DNL Campaign] utilizzando metriche pre-clic e tassi di conversione.</td>
   <td><ul style="margin-top: 0;">
...
<!--  ROW 2h  -->
<tr>
   <td>Utilizza i dati comportamentali di Adobe [!DNL Analytics] in Analysis Workspace nel Percorso di clienti [!DNL Analytics].</td>
   <td><ul style="margin-top: 0;">
...
<!--  ROW 3d  -->
<tr>
  <td>Utilizza i segmenti di Audience Manager per creare tipi di pubblico in Real-Time CDP da utilizzare nella personalizzazione e nel remarketing.</td>
  <td><ul style="margin-top: 0;">
        ...
        <li>Applica la rete dati di terze parti di Audience Manager per perfezionare ed espandere ulteriormente i tipi di pubblico per il targeting.</li>
      </ul></td>
