...
# Integrare Adobe [!DNL Analytics] con il Percorso clienti [!DNL Analytics]

{{analytics-description}}

{{customer-journey-analytics-description}}

L&#39;integrazione di Adobe [!DNL Analytics] con il Percorso di clienti [!DNL Analytics] offre vantaggi chiave:
        ...
        <tr>
            ...
            <td>
                <ul style="margin-top: 0;">
                    <li>Approccio consigliato per i clienti che hanno già implementato Adobe [!DNL Analytics] e desiderano che il modo più veloce per acquisire questi dati nell'esperienza [!DNL Platform] sia utilizzato nel Percorso di clienti [!DNL Analytics].</li>
