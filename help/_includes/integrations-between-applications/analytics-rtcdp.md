...
# Integrare Adobe [!DNL Analytics] con Real-Time Customer Data [!DNL Platform]
...
Combinando Adobe [!DNL Analytics] e Real-Time CDP, le aziende possono portare le loro attività di marketing a un livello successivo, offrendo esperienze personalizzate, aumentando il coinvolgimento dei clienti e ottimizzando le conversioni in vari punti di contatto digitali.
    ...
    <tr>
        ...
        <td>
            <ul style="margin-top: 0;">
                <li>Approccio consigliato per i clienti che hanno già implementato Adobe [!DNL Analytics] e desiderano che il modo più veloce per acquisire questi dati in Experience [!DNL Platform] da utilizzare nel Profilo cliente in tempo reale.</li>
       ...
       <td><a href="../../integrations/tutorials/analytics-rtcdp/experience-platform-edge.md" target="_blank" rel="noreferrer">Esperienza [!DNL Platform] Edge</a></td>
        <td>
            <ul style="margin-top: 0;">
                ...
                <li>Invia dati direttamente da un dispositivo all'esperienza [!DNL Platform] utilizzando AEP Web SDK, AEP Mobile SDK o l'API server di Edge Network.</li>
